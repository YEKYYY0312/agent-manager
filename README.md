...
agent管理器/
  ...
  packages/
    ...
    typescript-sdk/     Dependency-free Node/TypeScript Trace writer
...
For an isolated local installation, install through pipx. Open a new terminal
after `ensurepath`, then install the repository or the published package name:
...
- [Team Service and Evaluation](docs/team-service.md)
